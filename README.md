...
현대오토에버 모빌리티 SW 스쿨 2기 1조의 스마트팩토리 프로젝트입니다. 자동차 도장공정의 주요 설비를 실시간으로 모니터링하여, 고장을 사전에 예측하고 선제적으로 대응하는 시스템을 구축합니다.
...
## 🏗️ 시스템 아키텍처
<img width="657" height="327" alt="system" src="https://github.com/user-attachments/assets/..." />
